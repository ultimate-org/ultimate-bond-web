...
export async function GET() {
    try {
        ...
        const upcomingResponse = await fetch('http://192.168.29.64:8000/api/upcoming-workshops');
        ...
        const previousResponse = await fetch('http://192.168.29.64:8000/api/previous-workshops');
