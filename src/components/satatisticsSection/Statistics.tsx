    ...
    return (
      ...
      <div className={`flex flex-col h-auto md:flex-row  md:justify-evenly`}>
          <motion.div className='md:mr-8 mb-8 md:w-[30%]'>
              ...
              <p className={`${montserratRegular.className} text-base text-white ${styles.statisticsDescription}`}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequuntur error porro, quae minima natus eum aperiam possimus inventore. Iusto at nihil architecto, totam ut iure excepturi! Sint explicabo numquam magni.</p>
          </motion.div>
