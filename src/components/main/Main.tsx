...
//   return (
//     <div className="relative flex min-h-[100svh] w-full flex-col overflow-hidden pt-[var(--nav-h,80px)] font-['Poppins',sans-serif] antialiased lg:min-h-[100svh]">
//       <style>{`
//         @keyframes orbit-travel { to { offset-distance: 100%; } }
...
//         {/* HERO */}
//         <section className="relative flex w-full flex-1 items-center overflow-visible py-8 sm:py-10 lg:py-[clamp(24px,4vh,64px)]">
//           {/* Ambient glow blobs */}
//           <div
//             className="pointer-events-none absolute -left-[140px] -top-[180px] z-0 h-[260px] w-[260px] rounded-full opacity-[0.78] blur-[110px] sm:h-[440px] sm:w-[440px] lg:h-[620px] lg:w-[620px] lg:blur-[130px]"
//             style={{
...
//                 animate="visible"
//                 variants={fadeUp}
//                 className="relative z-[1] grid w-full max-w-full grid-cols-2 gap-2.5 text-left sm:gap-4 lg:max-w-full lg:grid-cols-4 lg:gap-3 xl:max-w-[720px] xl:gap-[18px]"
//               >
//                 {STATS.map((s) => (
//                   <div
//                     key={s.label}
//                     className="group relative z-[1] flex min-h-[110px] flex-col justify-between gap-2 overflow-hidden rounded-[16px] border border-white/30 bg-white/[0.07] p-[12px_12px_14px] backdrop-blur-[23px] transition-[transform,border-color,box-shadow] duration-850 ease-smooth hover:-translate-y-1.5 hover:scale-[1.025] hover:border-white/[0.48] sm:min-h-[130px] sm:rounded-[20px] sm:p-[14px_12px_16px] lg:min-h-[124px] lg:p-[14px_13px_16px]"
//                     style={{ boxShadow: GLASS_SHADOW }}
//                   >
//                     <GlassEdgeTop />
//                     <GlassEdgeLeft />
//                     <div
//                       className="inline-flex h-8 w-8 flex-shrink-0 items-center justify-center self-start rounded-[18px] text-[14px] text-white backdrop-blur-[10px] transition-transform duration-1100 ease-smooth group-hover:scale-110 sm:h-10 sm:w-10 sm:rounded-[20px] sm:text-[16px] lg:h-9 lg:w-9 lg:rounded-[20px] lg:text-[16px]"
//                       style={{
//                         background: s.badgeBg,
//                         border: `1px solid ${s.badgeStroke}`,
//                         boxShadow: `inset 0 1px 0 ${s.badgeInset}, inset 0 -1px 0 rgba(255,255,255,0.08), 0 4px 14px rgba(0,0,0,0.20)`,
...
//                     <div className="mt-auto flex flex-col gap-1.5">
//                       <div
//                         className="text-[clamp(18px,4.6vw,22px)] font-semibold leading-none sm:text-[24px] lg:text-[21px]"
//                         style={{ color: s.numColor }}
//                       >
//                         {s.num}
//                       </div>
...
//               animate="visible"
//               variants={fadeUp}
//               className="relative z-[2] hidden w-full lg:flex lg:flex-col lg:justify-center lg:gap-[clamp(12px,2.2vh,22px)]"
//             >
//               {TESTIMONIALS.map((t) => (
//                 <div
//                   key={t.id}
...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    iconStroke: "rgba(255,190,120,0.6)",
    iconInset: "rgba(255,220,180,0.55)",
    alignClass: "lg:self-start lg:ml-[8%] xl:ml-[14%]",
    delay: "-2.75s",
    duration: "5.5s",
  },
];
    ...
    <div className="relative flex min-h-[100svh] w-full flex-col overflow-hidden pt-[var(--nav-h,80px)] font-['Poppins',sans-serif] antialiased lg:min-h-[100svh]">
      ...
      <div className="hero-stack relative flex min-h-0 w-full flex-1 flex-col">
        ...
        <section className="relative flex w-full flex-1 items-center overflow-visible py-8 sm:py-10 lg:py-[clamp(24px,4vh,64px)]">
          ...
          {/* Mascot */}
          <div
            className="hidden lg:absolute lg:bottom-0 lg:right-0 lg:z-0 lg:flex lg:items-end lg:justify-end lg:h-[750px] lg:w-[680px]" id="mascot"
          >
            <video
              src="/videos/hero.webm"
              autoPlay
          ...
          {/* HERO INNER — content grid */}
          <div className="relative z-[1] mx-auto grid w-full max-w-[1600px] grid-cols-1 items-center gap-8 px-[clamp(20px,4vw,48px)] lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:gap-[clamp(24px,3vw,56px)]">
            {/* LEFT */}
            <div className="relative flex flex-col items-center text-center lg:items-start lg:text-left">
              {/* Pill */}
              <motion.div
                ...
                animate="visible"
                variants={fadeUp}
                className="relative z-[2] mb-[clamp(10px,1.4vh,20px)] inline-flex h-7 items-center gap-2 rounded-full border border-[rgba(255,154,64,0.55)] bg-white/[0.07] px-3 backdrop-blur-[23px] transition-colors duration-700 hover:border-[rgba(255,154,64,0.75)] sm:h-8 sm:gap-2.5 sm:px-3.5 lg:h-8 lg:px-[14px]"
                style={{ boxShadow: GLASS_SHADOW }}
              >
                <span className="h-1.5 w-1.5 rounded-full bg-[#ff9a40] sm:h-2 sm:w-2" />
                <span className="font-['Outfit',sans-serif] text-[10px] font-semibold uppercase tracking-[1.4px] text-[#ffb36b] sm:text-[11px] sm:tracking-[1.6px] lg:text-[11px] lg:tracking-[1.6px]">
                  Family Growth Platform
                </span>
              </motion.div>
              ...
              >
                <button
                  onClick={() => router.push("/download-app")}
                  className="cursor-pointer rounded-[10px] border-0 px-5 py-2.5 font-['Outfit',sans-serif] text-[13px] font-bold text-white transition-[transform,filter] duration-300 ease-smooth hover:-translate-y-px hover:brightness-105 sm:px-6 sm:py-3 sm:text-[14px]"
                  style={{ background: CTA_GRADIENT }}
                >
                  Get the App
                </button>
                ...
                <button
                  type="button"
                  onClick={handleScrollToJourney}
                  className="group inline-flex h-[2.5rem] sm:h-[2.75rem] cursor-pointer items-center gap-2 border-none bg-transparent px-3 sm:px-4 font-['Outfit',sans-serif] text-[15px] sm:text-[16px] font-bold tracking-[0.2px] text-[#ff9a40] transition-colors duration-300 ease-in-out hover:text-[#ffb677] hover:opacity-100"
                >
                  <span>See How It Works</span>
                  <span className="inline-flex h-[1rem] w-[1rem] items-center justify-center transition-transform duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:translate-x-[2px]">
                    <svg
                      viewBox="0 0 20 20"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
            ...
            {/* <motion.div
              ...
              animate="visible"
              variants={fadeUp}
              className="relative z-[2] hidden w-full lg:flex lg:flex-col lg:justify-start lg:gap-[clamp(12px,2.2vh,22px)] lg:pt-0 lg:-translate-y-[clamp(60px,12vh,150px)]"
            >
              {TESTIMONIALS.map((t) => (
                <div
                  key={t.id}
                  className={`group relative z-[3] flex w-[clamp(190px,17vw,250px)] flex-col gap-1.5 rounded-[18px] border border-white/30 bg-white/[0.07] p-[13px_15px_15px] backdrop-blur-[23px] transition-colors duration-700 hover:border-white/40 hover:[animation-play-state:paused] ${t.alignClass}`}
                  style={{
                    boxShadow: GLASS_SHADOW,
                    animation: `card-float ${t.duration} ease-in-out infinite`,
                    animationDelay: t.delay,
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      className="relative inline-flex h-8 w-8 flex-shrink-0 items-center justify-center overflow-hidden rounded-full font-['Outfit',sans-serif] text-[14px] font-bold text-white ring-1 ring-white/20"
                      style={{ background: t.avaBg }}
                    >
                      {t.images ? (
                        <img
                  ...
                  <p className="m-0 text-[12.5px] font-medium leading-[1.4] text-white">
                    &ldquo;{t.quote}&rdquo;
                  </p>
                  <p className="m-0 text-[11.5px] font-normal text-[#8b8a98]">
                    {t.author}
                  </p>
                  <span
                    className="absolute -right-3 -top-3.5 z-[4] inline-flex h-[34px] w-[34px] items-center justify-center rounded-[17px] text-[15px] text-white backdrop-blur-[10px] transition-transform duration-1000 ease-smooth group-hover:scale-105"
