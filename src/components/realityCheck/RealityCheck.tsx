...
export default function RealityCheck() {
  return (
    <section
      className="relative w-full overflow-hidden px-5 sm:px-7 lg:px-8 py-[clamp(3rem,8vh,7.5rem)] font-['Poppins',sans-serif] antialiased text-white bg-[#050507]"
    //   style={{ background: "linear-gradient(180deg, #0a0a14 0%, #08080d 100%)" }}
    ...
    >
      ...
      <div className="relative z-[1] mx-auto max-w-[950px]">
        ...
        >
          ...
          <motion.div
            variants={leftSlot}
            className="group/slot relative w-full max-w-[27rem] lg:max-w-[31rem]"
          >
            <img
              src="/images/checkreality/check-reality-1.webp"
              alt="School report card"
