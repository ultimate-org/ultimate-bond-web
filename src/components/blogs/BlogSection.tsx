...
//         {/* This will loop through blog topics and show each card */}
...
//       {/* For smaller screens, make it scrollable */}
//       {/* <div className="mt-8 w-full overflow-x-auto md:hidden px-4">
...
//         {
//           blogTopics.map((blogTopic) => {
//             return <SwiperSlide key={blogTopic.id}><BlogCard blogImageRoute={blogTopic?.blogImageRoute} blogTitle={blogTopic?.blogTitle}></BlogCard></SwiperSlide>
//           })
//         }
//       </Swiper>
//     </div>
