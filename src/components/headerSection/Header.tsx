...
//               {pgOpen && (
//                 <div className="absolute left-0 top-full z-[200] mt-3.5 flex max-w-[calc(100vw-2rem)] min-w-[560px] overflow-hidden rounded-b-[18px] border border-[rgba(249,115,22,0.18)] border-t-[3px] border-t-[#ff7a18] bg-white shadow-[0_24px_60px_rgba(0,0,0,0.35)]">
//                   {/* categories */}
//                   <div className="w-[210px] border-r border-[#f1f1f4] py-2">
//                     {PG_CATEGORIES.map((cat) => {
//                       const active = pgHovered === cat.id;
