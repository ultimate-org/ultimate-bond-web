...
export default function Journey() {
  ...
  return (
    ...
    >
      {/* Pinned viewport */}
      <div className="jn-pin sticky top-0 flex h-screen flex-col items-center justify-center gap-[clamp(15px,2.5vh,38px)] overflow-hidden px-[clamp(20px,4vw,48px)] py-[clamp(12px,2.5vh,32px)] max-[1040px]:static max-[1040px]:h-auto max-[1040px]:gap-[34px] max-[1040px]:px-[clamp(20px,4vw,48px)] max-[1040px]:py-[clamp(48px,7vw,90px)]">
        {/* Header */}
        <div className="relative z-[2] flex max-w-[820px] flex-col items-center gap-2.5 text-center">
          ...
          <h2 className="font-['Outfit',sans-serif] text-[clamp(24px,3vw,40px)] font-extrabold leading-[1.04] tracking-[-1.1px] text-white">
