...
import {FaYoutube, FaSquareFacebook, FaQuora, FaSquareInstagram, FaSquareXTwitter, FaLinkedin} from "react-icons/fa6"
                  ...
                  <div className=' flex flex-row my-2'>
                      {
                          socialMediaLinks.map((mediaLink) => {
                             return <Link key={mediaLink.id} href={mediaLink.link} className='mx-1 text-2xl' target='_blank'><mediaLink.icon></mediaLink.icon></Link>
                          })
                      }
                  </div>
              </div>
