...
const CONTENT: Record<string, string> = {
  ...
  school_life: `<h1>School Life</h1><p>What shapes your child's relationship with school — and with learning for the rest of their life — is what happens at home. The conversations after school. The way you respond when they fail a test. Whether they feel safe telling you when something is going wrong.</p><h2>Stop Asking 'How Was School?' — Ask This Instead</h2><ul><li>'What was the most annoying thing that happened today?'</li><li>'Did anything surprise you today?'</li><li>'Who made you laugh today?'</li><li>'Was there anything today where you felt really stuck?'</li><li>'If you could change one thing about school, what would it be?'</li></ul><h2>Ages 3–5: Make School Feel Like an Adventure</h2><ul><li>Never say 'school is boring' or 'I hated maths too' in front of your child.</li><li>When they come home excited about something they learned, stop what you are doing and let them teach you.</li><li>Keep morning routines calm and consistent.</li></ul><h2>Ages 6–9: Be Interested in Their Work, Not Just Their Grades</h2><ul><li>When they get a bad mark: ask 'what do you think went wrong?' before offering your view.</li><li>When they get a good mark: ask 'what did you do differently that worked?'</li><li>Show genuine interest in a subject they enjoy.</li><li>Help them build a homework habit — same time, same place, no negotiation.</li></ul><h2>Ages 10–13: Back Off the Academics — Stay Close to the Person</h2><ul><li>Resist the urge to increase tuitions as the default response to falling grades.</li><li>Keep the conversation about school balanced — for every question about homework, ask one about their social life.</li><li>Let them have at least one non-academic interest they pursue seriously.</li></ul>`,
  family_resources: `<h1>Family Resources</h1><p>Everything here is a tool — something you can pick up, use today, and come back to. Not philosophies to agree with. Actual frameworks, conversation starters, trackers, and guides that give you something concrete to do.</p><h2>30 Conversation Starters That Go Beyond 'How Was School?'</h2><h3>For Ages 3–6</h3><ul><li>What made you laugh today?</li><li>What was the hardest part of your day?</li><li>Did anything make you feel sad or upset today?</li><li>If you could change one thing about today, what would it be?</li><li>Who was the kindest person at school today and what did they do?</li><li>What is something you wish I knew about your day?</li><li>What are you looking forward to tomorrow?</li></ul><h3>For Ages 7–10</h3><ul><li>What was the most unfair thing that happened this week?</li><li>Did you do anything today that you are proud of, even a little?</li><li>Is there anything you are worried about right now?</li><li>What is something you tried this week that was hard?</li><li>If your best friend could describe you in three words, what would they say?</li><li>What do you think I worry about as a parent?</li><li>If you could teach the class something tomorrow, what would you teach?</li></ul><h3>For Ages 11–13</h3><ul><li>What is something you wish adults understood better about being your age?</li><li>Is there anything you have been thinking about a lot lately that you have not talked to anyone about?</li><li>What do you think you are genuinely good at — not just at school but as a person?</li><li>If you could change one rule in our house, what would it be and why?</li><li>What do you think I do not fully understand about your life right now?</li><li>What is something you have changed your mind about in the last year?</li><li>What is one thing you want to be better at — in life, not just in school?</li></ul>`,
  cb_01: `<h1>Why Children Lie</h1><p>If your child lies to you and you react with anger or punishment, there is a good chance they will lie to you again tomorrow — only more carefully. Because the lie was never really about dishonesty. It was about fear.</p><h2>The Real Reason Children Lie</h2><p>Children lie for one of four reasons: to avoid a consequence they fear, to protect a feeling, to test reality, or to protect someone else.</p><h2>Ages 3–5: The Wishful Thinking Stage</h2><ul><li>Do not treat it as a moral failure. Respond matter-of-factly.</li><li>Name the emotion underneath.</li><li>Use stories and role play to explore honesty.</li><li>Never set a trap — ask 'tell me what happened' not 'did you do this?'</li></ul><h2>Ages 6–9: The Consequence-Avoidance Stage</h2><ul><li>Make truth-telling feel safe. Your first response should be: 'I am glad you told me.'</li><li>Separate the behaviour from the lie.</li><li>Stop interrogating. Say what you know.</li></ul><h2>Ages 10–13: The Social Protection Stage</h2><ul><li>Stay curious, not suspicious.</li><li>When you catch a lie, stay calm.</li><li>Share your own experiences of lying as a young person — as a story, not a lesson.</li></ul><h2>How to Respond When You Catch a Lie</h2><ul><li><strong>Step 1 — Pause:</strong> Take a breath before you respond.</li><li><strong>Step 2 — State what you know.</strong></li><li><strong>Step 3 — Address the underlying behaviour.</strong></li><li><strong>Step 4 — Name the cost of lying.</strong></li><li><strong>Step 5 — Leave the door open:</strong> 'You can always tell me things. Even hard things.'</li></ul>`,
  cb_02: `<h1>Why Kids Talk Back</h1><p>Talking back is almost never about disrespect. It is about a developing brain that has just discovered it can argue — and a child who is testing whether you can handle disagreement without breaking.</p><h2>Ages 3–5: The 'No' Stage</h2><ul><li>Pick your battles. Not every 'no' needs a confrontation.</li><li>Offer controlled choices.</li><li>Avoid power struggles over small things.</li></ul><h2>Ages 6–9: The 'That's Not Fair' Stage</h2><ul><li>Explain your reasoning once, briefly.</li><li>Acknowledge their perspective before holding your position.</li><li>Do not match their emotional intensity.</li><li>Tell them when they have made a fair point.</li></ul><h2>Ages 10–13: The Full Argument Stage</h2><ul><li>Pause before responding.</li><li>Engage the substance, not the tone.</li><li>Be willing to change your mind when they are right.</li><li>Hold the line on how they speak to you.</li></ul><h2>The Responses That Escalate and the Ones That Don't</h2><ul><li><strong>Escalates:</strong> 'Because I said so, that's why.'</li><li><strong>De-escalates:</strong> 'The reason is this. I want you to understand my thinking.'</li><li><strong>Escalates:</strong> Matching their volume and emotional intensity.</li><li><strong>De-escalates:</strong> Lowering your voice. A quiet parent is more powerful than a loud one every single time.</li></ul>`,
  cb_03: `<h1>Dealing With a Stubborn Child</h1><p>The child everyone calls stubborn is usually the one who knows what they want, refuses to be pushed around, and holds their position under pressure. In twenty years, those are exactly the qualities that will make them successful.</p><h2>Ages 3–5: The 'I Do It Myself' Stage</h2><ul><li>Give them the genuine experience of doing it themselves wherever possible.</li><li>Build in extra time.</li><li>Use 'when-then': 'When your shoes are on, then we can go.'</li><li>Avoid direct commands wherever you can.</li></ul><h2>Ages 6–9: The 'I Won't and You Can't Make Me' Stage</h2><ul><li>Involve them in decisions.</li><li>Explain the real reason, not just the rule.</li><li>Give them a face-saving exit.</li><li>Avoid public confrontations.</li></ul><h2>Ages 10–13: The 'I Have a Point and I'm Not Moving' Stage</h2><ul><li>Genuinely consider their argument before dismissing it.</li><li>Be extremely clear about what is non-negotiable and keep that list short.</li><li>State it once, clearly, with the reason. Then do not engage with the argument.</li><li>Let natural consequences do the teaching for anything that is not a safety issue.</li></ul>`,
  cb_04: `<h1>Discipline Without Punishment</h1><p>Punishment makes a child feel bad. Discipline teaches a child to do better.</p><h2>Tool 1: Natural Consequences</h2><p>Let the situation itself teach the lesson. Forgot the water bottle — goes thirsty.</p><h2>Tool 2: Logical Consequences</h2><p>Directly connected to the behaviour. Misuses the tablet — loses tablet access.</p><h2>Tool 3: Problem-Solving Conversations</h2><ul><li>'Tell me what happened from your perspective.'</li><li>'What were you feeling just before that?'</li><li>'What would you do differently?'</li></ul><h2>Tool 4: Positive Reinforcement Done Right</h2><ul><li><strong>Wrong:</strong> 'Good boy for sharing.'</li><li><strong>Right:</strong> 'You noticed your cousin wanted a turn and you gave him one without being asked. That was a generous choice.'</li></ul>`,
  cb_05: `<h1>Handling Aggressive Behaviour</h1><p>Children become physically or verbally aggressive when they have run out of other ways to express what they are experiencing.</p><h2>Ages 3–5: Physical Overflow</h2><ul><li>Ensure safety first — physically separate children if needed, calmly.</li><li>Do not match the energy. Get low, speak slowly and quietly.</li><li>Name the emotion without judgement.</li><li>Wait. Do not try to teach during the storm.</li></ul><h2>Ages 6–9: Reactive Aggression</h2><ul><li>Address the aggression and the trigger separately.</li><li>Teach a pause strategy when they are calm — not in the moment.</li><li>Role-play difficult situations.</li></ul><h2>Ages 10–13: Verbal Aggression</h2><ul><li>Stay calm and lower your voice.</li><li>Name the behaviour without attacking the character.</li><li>Exit the immediate conflict to prevent escalation.</li></ul><h2>Long-Term Strategies</h2><ul><li>Build a daily physical outlet.</li><li>Regulate their sleep.</li><li>Build emotional vocabulary consistently over time.</li><li>Model emotional regulation yourself.</li></ul>`,
  cb_06: `<h1>Why Children Refuse to Listen</h1><p>Children learn, through consistent experience, exactly how many times they need to wait before compliance is actually required.</p><h2>Ages 3–5: Developmental Capacity, Not Defiance</h2><ul><li>Get physical proximity first.</li><li>Give a transition warning: 'In five minutes we are going to put the toys away.'</li><li>Use 'when-then' framing.</li><li>Follow through every time.</li></ul><h2>Ages 6–9: Strategic Non-Listening</h2><ul><li>Say it once. Then act.</li><li>Get confirmation: 'Can you tell me what I just asked you to do?'</li><li>Remove distractions before instructing.</li><li>Make the consequence logical and immediate.</li></ul><h2>Ages 10–13: Selective Processing</h2><ul><li>Lower your expectations of compliance through instruction alone.</li><li>Name what you observe without drama.</li><li>Be genuinely willing to hear what they say.</li></ul><h2>The Instructions That Never Work</h2><ul><li>Shouted instructions from another room</li><li>Instructions without reasons</li><li>Instructions delivered in a questioning tone</li><li>Repeated instructions with no consequence</li></ul>`,
  cb_07: `<h1>How to Handle Sibling Fights</h1><p>Sibling conflict is one of the most valuable developmental experiences your children will ever have — if you stop managing it and start using it.</p><h2>The Most Common Parenting Mistakes</h2><ul><li>Immediately taking sides</li><li>Finding out who started it</li><li>Solving it for them</li><li>Comparing them to each other</li><li>Intervening too early</li></ul><h2>Ages 3–6: Narrate and Separate</h2><ul><li>Separate them physically without drama.</li><li>Narrate both perspectives.</li><li>Name the rule: 'In this house we do not hurt each other.'</li><li>Redirect to the solution.</li></ul><h2>Ages 6–10: Hand the Problem Back</h2><p>'I am going to give you five minutes to figure it out between you. If you cannot, I will make the decision for both of you — and neither of you will like it.' Then actually leave the room.</p><h2>Ages 10–13: Facilitate, Don't Adjudicate</h2><ul><li>Have a family conversation about what fair conflict resolution looks like.</li><li>Invite both children to describe their experience.</li><li>Ask what they each need rather than what they want.</li></ul>`,
  cb_08: `<h1>Why Children Throw Tantrums</h1><p>A tantrum is a neurological event — a young brain overwhelmed by an emotion it does not yet have the infrastructure to manage.</p><h2>Before the Tantrum: Prevention</h2><ul><li>Track the triggers.</li><li>Give warnings before transitions: 'In five minutes we are leaving the park.'</li><li>Ensure sleep and meals are consistent.</li><li>Offer choices within limits.</li></ul><h2>During the Tantrum: Step by Step</h2><ul><li><strong>Step 1:</strong> Regulate yourself first.</li><li><strong>Step 2:</strong> Get low and close — kneel to their level.</li><li><strong>Step 3:</strong> Use minimal words. 'I am here. You are safe.'</li><li><strong>Step 4:</strong> Wait it out. Do not bribe, threaten, or give in.</li><li><strong>Step 5:</strong> Reconnect after — a hug, a quiet 'that was a big feeling.'</li></ul><h2>What Makes Tantrums More Frequent</h2><ul><li><strong>Tiredness:</strong> The single biggest predictor of tantrum frequency.</li><li><strong>Hunger:</strong> Blood sugar drops are a major tantrum trigger.</li><li><strong>Overscheduling:</strong> Chronically overstimulated children have more tantrums.</li><li><strong>Inconsistency:</strong> Children who do not know what to expect experience more anxiety and more tantrums.</li></ul>`,
  cb_09: `<h1>Teaching Respect to Children</h1><p>Respect is built through relationship, modelled through behaviour, and earned through how you treat your child — not through how much authority you claim.</p><h2>Ages 3–5: Mirror What You Want to See</h2><ul><li>Say please and thank you to everyone — the autorickshaw driver, the vegetable vendor, the delivery person.</li><li>Introduce the idea that other people have feelings.</li><li>When your child is rude, address it without shame: 'That was not kind. Let's try that again.'</li></ul><h2>Ages 6–9: Name Respect in Everyday Moments</h2><ul><li>When you see disrespectful behaviour, name it.</li><li>Teach the difference between agreeing with someone and respecting them.</li><li>When your child speaks disrespectfully to you: 'That was rude. I would like you to say that again differently.' Then wait.</li></ul><h2>Ages 10–13: Discuss, Don't Dictate</h2><ul><li>Have a conversation — not a lecture — about what respect means to your family.</li><li>Be explicit when you make a mistake: 'I spoke to you sharply earlier and you didn't deserve that. I am sorry.'</li><li>Let them call you out respectfully when you are being disrespectful.</li></ul>`,
  cb_10: `<h1>Setting Boundaries With Kids</h1><p>Children without clear boundaries are not free. They are anxious.</p><h2>The Characteristics of Boundaries That Work</h2><ul><li><strong>Clear:</strong> 'Be home by 5' is a boundary. 'Come home at a reasonable time' is not.</li><li><strong>Explained:</strong> Children who understand the reason are significantly more likely to respect it.</li><li><strong>Consistent:</strong> A boundary that shifts based on your mood is not a boundary.</li><li><strong>Followed through:</strong> Every boundary stated and not enforced weakens every future boundary.</li><li><strong>Proportionate:</strong> The consequence for crossing a boundary should fit the boundary.</li></ul><h2>Ages 3–5: Simple, Physical, Immediate</h2><ul><li>Choose two or three genuinely non-negotiable boundaries and hold only those firmly.</li><li>State the boundary at a neutral moment, not in the middle of a conflict.</li></ul><h2>Ages 6–9: Negotiate Within the Framework</h2><ul><li>Have a family conversation about house rules.</li><li>Let them propose rules and consequences.</li></ul><h2>Ages 10–13: Negotiate the Boundary Itself</h2><ul><li>Identify your true non-negotiables. There are probably fewer than you think.</li><li>Increase autonomy explicitly as trust is demonstrated.</li></ul>`,
  ed_01: `<h1>Building Emotional Resilience</h1><p>Resilience means your child can experience difficulty fully, be genuinely affected by it, and recover — not unchanged, but stronger.</p><h2>The 4 Pillars</h2><h3>Pillar 1: Secure Attachment</h3><ul><li>Be consistently available — not perfect, but predictable.</li><li>Repair ruptures quickly.</li><li>Make your love unconditional and visible.</li></ul><h3>Pillar 2: Emotional Competence</h3><ul><li>Create a home where all emotions are welcome.</li><li>Help them develop a nuanced emotional vocabulary.</li><li>Teach them that emotions are temporary.</li></ul><h3>Pillar 3: Self-Efficacy</h3><ul><li>Allow age-appropriate struggle.</li><li>Let them fail. Failure is the raw material from which resilience is built.</li></ul><h3>Pillar 4: Problem-Solving Orientation</h3><ul><li>When your child comes with a problem, ask: 'What do you think you could do about it?'</li><li>After difficulty, build the habit of debrief.</li></ul><h2>What Undermines Resilience — Stop Doing These</h2><ul><li>Eliminating all difficulty</li><li>Rescuing from consequences</li><li>Catastrophising</li><li>Teaching helplessness</li></ul>`,
  ed_02: `<h1>Emotional Intelligence in Children</h1><p>Academic success, social confidence, strong friendships, resilience under pressure — the one thing that predicts all of these better than IQ is emotional intelligence.</p><h2>The Four Components</h2><ul><li><strong>Self-awareness:</strong> Recognising and naming what you feel.</li><li><strong>Self-regulation:</strong> Managing emotions rather than being controlled by them.</li><li><strong>Empathy:</strong> Recognising and understanding what other people feel.</li><li><strong>Social skills:</strong> Using emotional awareness in relationships.</li></ul><h2>Ages 3–5: Building the Emotional Vocabulary</h2><ul><li>Name their emotions for them, specifically and without judgment.</li><li>Use a feelings vocabulary that goes beyond happy, sad, and angry.</li><li>Read stories together and pause to ask what the character might be feeling.</li></ul><h2>Ages 6–9: Developing Self-Regulation Strategies</h2><ul><li>Teach the gap between feeling and action explicitly.</li><li>Help them build a personal emotional toolkit.</li><li>Model your own emotional intelligence openly.</li></ul><h2>5 Common Mistakes That Undermine Emotional Intelligence</h2><ul><li>Dismissing emotions</li><li>Fixing instead of feeling</li><li>Punishing emotions</li><li>Modelling emotional suppression</li><li>Labelling children by their emotions</li></ul>`,
  ed_03: `<h1>Helping Children Express Emotions</h1><p>Every behaviour problem that baffles a parent has an unexpressed emotion underneath it.</p><h2>Why Children Struggle to Express Emotions</h2><ul><li>They lack the vocabulary.</li><li>They have been taught that certain emotions are not acceptable.</li><li>They do not feel safe enough.</li><li>They do not have a model.</li></ul><h2>Ages 3–5: Give Them the Words</h2><ul><li>Narrate what you observe: 'I think you might be feeling really frustrated.'</li><li>Use emotion check-ins at calm moments.</li><li>Never correct their emotion.</li></ul><h2>Ages 6–9: Build the Habit of Emotional Communication</h2><ul><li>Create a regular, low-pressure space for emotional expression.</li><li>Introduce 'I feel _____ because _____' as a sentence structure.</li><li>When they express something difficult, respond with acknowledgment before anything else.</li></ul><h2>What Blocks Emotional Expression — Stop Doing These</h2><ul><li>Interrogating instead of inviting</li><li>Offering solutions before listening</li><li>Making it about you</li><li>Time-pressuring expression</li></ul>`,
  ed_04: `<h1>Helping Children Overcome Fear</h1><p>The brave child is not the one who feels no fear. The brave child is the one who feels fear and acts anyway.</p><h2>Common Childhood Fears by Age</h2><ul><li><strong>Ages 3–5:</strong> Imaginative fears — the dark, monsters, loud noises, separation from parents.</li><li><strong>Ages 6–9:</strong> Concrete fears — injury, natural disasters, bad people, death.</li><li><strong>Ages 10–13:</strong> Social fears — embarrassment, rejection, failure, not fitting in.</li></ul><h2>The Golden Rule: Validate, Then Approach</h2><p><strong>Step 1:</strong> Validate the fear completely. Do not minimise it.</p><p><strong>Step 2:</strong> Support gradual approach — never forcing, always supporting.</p><h2>What Makes Childhood Fears Worse — Stop Doing These</h2><ul><li>Forcing confrontation</li><li>Ridiculing fear</li><li>Transferring your own fears</li><li>Reassurance on repeat</li></ul>`,
  ed_05: `<h1>Helping Kids Deal with Frustration</h1><p>Frustration is the emotion children feel most frequently. On the other side of frustration is growth.</p><h2>The Frustration Cycle</h2><p><strong>Unhealthy:</strong> Attempt → Failure → Frustration → Emotional reaction → Giving up</p><p><strong>Healthy:</strong> Attempt → Failure → Frustration → Pause → Adjusted attempt → Progress</p><h2>Ages 3–5: Keep It Small and Supported</h2><ul><li>Sit with them in the frustration. Your presence is regulating.</li><li>Resist the urge to do it for them. Guide rather than rescue.</li><li>Celebrate the persistence, not just the result.</li></ul><h2>Ages 6–9: Build the Frustration Toolkit</h2><ul><li>Teach the 'pause and breathe' technique explicitly.</li><li>Introduce the 'stuck' protocol: (1) Try again differently. (2) Break it into parts. (3) Take a break. (4) Ask for help.</li></ul><h2>What Makes Frustration Worse — Stop Doing These</h2><ul><li>Saying 'it's easy'</li><li>Rescuing immediately</li><li>Adding pressure</li><li>Comparing to others</li></ul>`,
  ed_06: `<h1>Helping Kids Handle Disappointment</h1><p>Your job is not to prevent disappointment. It is to be present while they experience it — and to help them discover that they can survive it.</p><h2>Ages 3–5: Name It and Stay Close</h2><ul><li>Name the feeling specifically.</li><li>Do not rush to fix it. Let them feel the disappointment first.</li><li>Avoid minimising.</li></ul><h2>Ages 6–9: Build the Recovery Muscle</h2><ul><li>Validate first, coach second.</li><li>Help them separate effort from outcome.</li><li>Introduce 'Plan B thinking.'</li></ul><h2>Ages 10–13: Develop Perspective Without Dismissing</h2><ul><li>Listen more than you advise.</li><li>Help them distinguish between disappointment and failure.</li></ul><h2>What Makes Disappointment Harder — Stop Doing These</h2><ul><li>Preventing all disappointment</li><li>Toxic positivity</li><li>Comparing disappointments</li><li>Fixing it immediately</li></ul>`,
  ed_07: `<h1>Managing Tantrums (Age 3–6)</h1><p>A tantrum is your child's nervous system hitting a wall it cannot climb over.</p><h2>Before the Tantrum: Prevention</h2><ul><li>Track the triggers.</li><li>Address the basics first: a well-rested, well-fed child has dramatically fewer tantrums.</li><li>Give warnings before transitions.</li><li>Offer choices within limits.</li></ul><h2>During the Tantrum: Step by Step</h2><ul><li><strong>Step 1:</strong> Regulate yourself first.</li><li><strong>Step 2:</strong> Get low and close.</li><li><strong>Step 3:</strong> Use minimal words: 'I am here. You are safe.'</li><li><strong>Step 4:</strong> Wait it out.</li><li><strong>Step 5:</strong> Reconnect after — before you correct.</li></ul><h2>What Makes Tantrums Worse — Stop Doing These</h2><ul><li>Saying 'stop crying'</li><li>Giving in to end it</li><li>Punishing tantrums</li><li>Ignoring completely</li><li>Threatening</li></ul>`,
  ed_08: `<h1>Raising Emotionally Strong Children</h1><p>The emotionally strong child is not the one who never cries. It is the child who feels deeply, recovers effectively, and grows through difficulty.</p><h2>5 Daily Practices That Build Emotional Strength</h2><ul><li><strong>Let them feel everything.</strong></li><li><strong>Validate before you redirect:</strong> 'That sounds really hard.' before anything else.</li><li><strong>Model your own emotional process.</strong></li><li><strong>Give them real responsibility.</strong></li><li><strong>Teach constructive self-talk:</strong> 'I can try again.' 'This is hard but I can handle it.'</li></ul><h2>What Weakens Emotional Strength — Stop Doing These</h2><ul><li>Over-protecting</li><li>Equating emotion with weakness</li><li>Fixing everything for them</li><li>Praising only outcomes</li></ul>`,
  ed_09: `<h1>Teaching Patience to Children</h1><p>Patience is not a personality trait some children are born with. It is a skill that depends on the development of impulse control, emotional regulation, and the ability to tolerate discomfort.</p><h2>Ages 3–5: Tiny Waits With Big Support</h2><ul><li>Start with waits that have a visible end point.</li><li>Name the skill when they demonstrate it.</li><li>Play waiting games — red light/green light, Simon says.</li></ul><h2>Ages 6–9: Stretching the Patience Muscle</h2><ul><li>Introduce delayed rewards.</li><li>Help them develop personal waiting strategies.</li><li>Use cooking and gardening as patience teachers.</li></ul><h2>What Undermines Patience — Stop Doing These</h2><ul><li>Instant entertainment at every pause</li><li>Rewarding impatience</li><li>Breaking promises about timing</li><li>Being impatient yourself</li></ul>`,
  ed_10: `<h1>Why Children Get Angry</h1><p>Anger in children is almost never really about anger. It is about frustration, injustice, fear, embarrassment, powerlessness, or hurt that the child cannot process or express any other way.</p><h2>Ages 3–5: Big Feelings in Small Bodies</h2><ul><li>Acknowledge the frustration before addressing the behaviour.</li><li>Reduce the triggers where possible.</li><li>Stay physically close and calm.</li></ul><h2>Ages 6–9: The Growing Sense of Justice</h2><ul><li>Take their sense of fairness seriously, even when you disagree.</li><li>Look for the hurt underneath the anger.</li><li>Give them a voice in family decisions where appropriate.</li></ul><h2>Ages 10–13: Complex Anger in Pre-Teens</h2><ul><li>Do not take the anger personally.</li><li>Offer physical outlets.</li><li>Distinguish between the anger and the issue.</li></ul><h2>What Makes Children's Anger Worse — Stop Doing These</h2><ul><li>Matching their intensity</li><li>Demanding immediate calm</li><li>Dismissing the trigger</li><li>Using anger as a teaching moment during the anger</li><li>Withholding affection as punishment for anger</li></ul>`,
  hd_01: `<h1>Building Reading Habits</h1><p>Reading is the single habit that predicts academic success more reliably than any other factor.</p><h2>Ages 3–5: Make Books Part of the Furniture</h2><ul><li>Read aloud every single day. Bedtime is the most powerful anchor.</li><li>Let them choose the book, even if it is the same book for the fourteenth consecutive night.</li><li>Have books everywhere.</li><li>Do not turn reading into a lesson.</li></ul><h2>Ages 6–9: Protect the Pleasure</h2><ul><li>Maintain a daily reading time separate from school reading.</li><li>Let them abandon books they do not enjoy.</li><li>Introduce them to series.</li><li>Read alongside them.</li></ul><h2>Ages 10–13: Respect Their Taste</h2><ul><li>Respect their genre preferences absolutely. Fantasy, horror, graphic novels, manga — all of it counts.</li><li>Connect reading to their interests.</li><li>Discuss books as equals, not as teacher and student.</li></ul><h2>What Kills Reading Habits — Stop Doing These</h2><ul><li>Making reading a punishment or obligation</li><li>Restricting their choices</li><li>Competing with screens at reading time</li><li>Testing comprehension after every chapter</li><li>Not reading yourself</li></ul>`,
  hd_02: `<h1>Daily Routines for Children</h1><p>A good daily routine is the closest thing to a parenting superpower.</p><h2>The Three Blocks</h2><h3>The Morning Block</h3><p>Wake up → hygiene → get dressed → eat breakfast → pack bag → leave.</p><h3>The After-School Block</h3><p>Arrive home → snack and decompression (15–20 minutes) → homework → free time → dinner.</p><h3>The Evening Block</h3><p>Dinner → tidy up/pack bag for tomorrow → bath/shower → reading or quiet time → lights out.</p><h2>Building Routines by Age</h2><h3>Ages 3–5: Visual and Simple</h3><ul><li>Use a picture chart they can follow.</li><li>Keep the routine to 4–6 steps.</li></ul><h3>Ages 6–9: Collaborative and Growing</h3><ul><li>Build the routine together.</li><li>Introduce a checklist they can tick off themselves.</li></ul><h3>Ages 10–13: Owned and Flexible</h3><ul><li>Let them design their own routine within your non-negotiable framework.</li><li>Allow them to adjust and iterate.</li></ul>`,
  hd_03: `<h1>Helping Kids Stay Organized</h1><p>Organisation is not something children are born with or without. It is a set of learnable systems.</p><h2>Ages 3–5: Everything Has a Home</h2><ul><li>Label storage with pictures.</li><li>Teach 'one out, one back.'</li><li>Use the same spot for essentials every single day.</li></ul><h2>Ages 6–9: Systems and Checklists</h2><ul><li>Help them set up a homework station with all supplies in one place.</li><li>Introduce a 'landing pad' by the door.</li><li>Teach the weekly bag check: every Sunday, empty the bag completely, sort, restock.</li><li>Use colour-coding for school subjects.</li></ul><h2>Ages 10–13: Self-Managing Systems</h2><ul><li>Help them set up a planner or digital calendar.</li><li>Introduce the 5-minute tidy at the end of each day.</li><li>Let them design their own workspace.</li></ul>`,
  hd_04: `<h1>How Children Develop Habits</h1><p>A habit is not a decision. It is a behaviour that has been repeated so many times it becomes automatic.</p><h2>The Science of Habit Formation</h2><p>Every habit follows a three-part loop:</p><ul><li><strong>Cue:</strong> Something that triggers the behaviour.</li><li><strong>Routine:</strong> The behaviour itself.</li><li><strong>Reward:</strong> Something that makes the brain want to repeat the loop.</li></ul><h2>How Long Does It Take?</h2><ul><li>Simple habits: 3–6 weeks.</li><li>Moderate habits: 6–12 weeks.</li><li>Complex habits: 3–6 months.</li></ul><h2>What Undermines Habit Formation — Stop Doing These</h2><ul><li>Inconsistency — the single biggest killer of habit formation</li><li>Too many habits at once</li><li>Nagging instead of cueing</li><li>Expecting willpower — children need environmental support</li></ul>`,
  hd_05: `<h1>Morning Routines for Kids</h1><p>If your mornings involve shouting 'we are going to be late' — you do not have a discipline problem. You have a systems problem.</p><h2>Ages 3–5: The Picture Chart System</h2><p>1. Wake up 2. Use the toilet and wash hands 3. Get dressed 4. Eat breakfast 5. Brush teeth 6. Shoes and bag on 7. Ready to leave</p><h2>Ages 6–9: The Checklist System</h2><ul><li>A written checklist they can tick off.</li><li>Teach them to pack their bag the night before.</li><li>Do not hover.</li></ul><h2>Ages 10–13: The Self-Managed System</h2><ul><li>They set their own alarm.</li><li>One parental time check: 'We leave in 15 minutes.'</li><li>Natural consequences apply.</li></ul><h2>The Night-Before Prep That Makes Mornings Work</h2><ul><li>Clothes laid out or chosen.</li><li>Bag packed and by the door.</li><li>Breakfast decided.</li><li>A consistent bedtime — the number one cause of terrible mornings is insufficient sleep.</li></ul>`,
  hd_06: `<h1>Teaching Responsibility at Home</h1><p>Responsibility is not taught through lectures. It is taught through experience — real tasks, real consequences, and the real satisfaction of contributing to something that matters.</p><h2>The Mindset Shift: From Chores to Contribution</h2><p>'Everyone in this family has a role. My role is to cook dinner. Your role is to set the table. We are a team.'</p><h2>Age-Appropriate Responsibilities</h2><h3>Ages 3–5</h3><ul><li>Put toys away, carry plate to sink, help feed a pet, water a plant, help set the table.</li></ul><h3>Ages 6–9</h3><ul><li>Make their own bed, pack school bag, clear table after meals, sort laundry, help prepare simple food.</li></ul><h3>Ages 10–13</h3><ul><li>Cook a simple meal, do their own laundry, clean a bathroom, manage homework schedule without reminders.</li></ul>`,
  hd_07: `<h1>Teaching Self Discipline</h1><p>There are two kinds of disciplined children. The first behaves well because an adult is watching. The second behaves well because they have internalised the standards.</p><h2>What Self Discipline Actually Is</h2><ul><li><strong>Impulse control:</strong> The ability to pause between a desire and an action.</li><li><strong>Delayed gratification:</strong> The ability to choose a larger later reward over a smaller immediate one.</li><li><strong>Self-regulation:</strong> The ability to manage emotions, attention, and behaviour in pursuit of a goal.</li></ul><h2>Ages 3–5: The Foundations of Impulse Control</h2><ul><li>Play games that require impulse control: Simon says, red light/green light, freeze dance.</li><li>Use 'when-then' consistently.</li></ul><h2>Ages 6–9: Building the Muscle</h2><ul><li>Introduce 'hard now, easy later' versus 'easy now, hard later.'</li><li>Give them increasing autonomy with clear expectations.</li></ul><h2>Ages 10–13: From External to Internal</h2><ul><li>Have explicit conversations about self discipline as a competitive advantage.</li><li>Reduce external controls gradually.</li><li>Model your own self-discipline openly.</li></ul>`,
  hd_08: `<h1>Teaching Time Management to Kids</h1><p>Every morning chaos scenario has the same root cause: a child who has not yet learned to manage time.</p><h2>Ages 3–5: Make Time Visible</h2><ul><li>Use visual timers.</li><li>Use 'first-then' language.</li></ul><h2>Ages 6–9: Build Estimation and Planning Skills</h2><ul><li>Play the 'how long will it take' game.</li><li>Introduce a simple planner or calendar.</li><li>Teach backward planning for projects.</li><li>Let them experience the consequences of poor time management.</li></ul><h2>Ages 10–13: Teach Self-Management</h2><ul><li>Help them design their own weekly schedule.</li><li>Introduce the concept of prioritisation.</li><li>Discuss time wasters honestly.</li></ul><h2>What Undermines Time Management — Stop Doing These</h2><ul><li>Managing all their time for them</li><li>Rescuing them from time-related consequences</li><li>Over-scheduling</li><li>Vague time references: 'We're leaving soon' means nothing.</li></ul>`,
  hd_09: `<h1>Screen Time Balance for Kids</h1><p>What matters is how much, what kind, when, and what screens are replacing.</p><h2>Guidelines by Age</h2><ul><li><strong>Ages 3–5:</strong> 30 minutes to 1 hour per day of high-quality content. No screens in the hour before bedtime.</li><li><strong>Ages 6–9:</strong> 1–1.5 hours of recreational screen time per day, after homework, physical activity, and responsibilities are complete.</li><li><strong>Ages 10–13:</strong> 1.5–2 hours, with the child increasingly managing their own limits.</li></ul><h2>The Screen Time Rules That Actually Work</h2><ul><li>Screens come after, not before.</li><li>No screens in bedrooms — devices charge in a communal area overnight.</li><li>No screens during meals — this applies to parents too.</li><li>Not all screen time is equal — creating content is different from consuming it.</li><li>Model what you expect.</li></ul>`,
  hd_10: `<h1>Why Routines Help Children</h1><p>Ask any child psychologist what the single most effective non-therapeutic intervention for childhood anxiety is, and most will say the same thing: a consistent daily routine.</p><h2>The Science: How Routines Affect the Developing Brain</h2><ul><li><strong>Routines reduce cortisol.</strong></li><li><strong>Routines build neural efficiency.</strong></li><li><strong>Routines develop executive function.</strong></li><li><strong>Routines support emotional regulation.</strong></li></ul><h2>The Specific Ways Routines Help</h2><ul><li>Reduce anxiety and behavioural problems.</li><li>Build independence and confidence.</li><li>Improve sleep.</li><li>Reduce family conflict.</li><li>Help children through transitions.</li></ul><h2>What Undermines Routines — Stop Doing These</h2><ul><li>Total inconsistency</li><li>Over-complexity</li><li>No transition support</li><li>Abandoning routine during holidays</li><li>Making it punitive</li></ul>`,
  sl_01: `<h1>Bullying in Primary Schools</h1><p>Research consistently shows that one in four to five children will experience bullying during their primary school years.</p><h2>What Bullying Actually Is</h2><p>Bullying is repeated, intentional aggressive behaviour directed at a specific child by someone with more social or physical power. The three defining features are: repetition, intent, and power imbalance.</p><h2>Types of Bullying</h2><ul><li><strong>Physical bullying:</strong> Hitting, pushing, kicking, taking or damaging belongings.</li><li><strong>Verbal bullying:</strong> Name-calling, insults, threats, taunting.</li><li><strong>Social bullying:</strong> Deliberate exclusion, spreading rumours, public humiliation.</li><li><strong>Cyberbullying:</strong> Hurtful messages, social media exclusion, sharing embarrassing content.</li></ul><h2>How to Respond When Your Child Is Being Bullied</h2><ul><li><strong>Step 1:</strong> Listen without overreacting.</li><li><strong>Step 2:</strong> Gather information calmly.</li><li><strong>Step 3:</strong> Document everything.</li><li><strong>Step 4:</strong> Contact the school strategically, in writing.</li><li><strong>Step 5:</strong> Build your child's resilience alongside school intervention.</li></ul><h2>What to Tell Your Child</h2><p><strong>Do say:</strong> 'This is not your fault.' / 'You did the right thing telling me.'</p><p><strong>Do not say:</strong> 'Just ignore them.' / 'Hit them back.'</p>`,
  sl_02: `<h1>Encouraging Curiosity in Kids</h1><p>A curious child does not need to be motivated to learn. They are already motivated. Your job is simply to not get in the way.</p><h2>Ages 3–5: Follow Their Lead</h2><ul><li>When they ask 'why?' answer. Then ask them back: 'Why do YOU think?'</li><li>Let them explore freely within safety boundaries.</li><li>Wonder aloud. 'I wonder why the sky turns orange at sunset. What do you think?'</li></ul><h2>Ages 6–9: Deepen and Broaden</h2><ul><li>When they show interest in something, invest in it.</li><li>Encourage questions over answers.</li><li>Let them go deep into a topic they love.</li></ul><h2>Ages 10–13: Connect Curiosity to Identity</h2><ul><li>Connect curiosity to people they admire.</li><li>Give them real problems to solve.</li><li>Do not shut down challenging questions.</li></ul><h2>What Kills Curiosity — Stop Doing These</h2><ul><li>Always giving the answer immediately</li><li>Correcting exploration</li><li>Over-scheduling — boredom is where curiosity begins</li><li>Valuing grades over learning</li></ul>`,
  sl_03: `<h1>Helping Children Focus on Studies</h1><p>The ability to focus is developmental. A 5-year-old can sustain attention for roughly 10–15 minutes. A 10-year-old can manage 20–30 minutes.</p><h2>Ages 6–9: Structure the Environment</h2><ul><li>Create a dedicated study space — quiet, well-lit, clear of distractions.</li><li>Use the Pomodoro technique adapted for kids: 15–20 minutes of focused work, followed by a 5-minute break.</li><li>Remove screens from the study area completely.</li><li>Start with the hardest subject.</li></ul><h2>Ages 10–13: Teach Self-Management</h2><ul><li>Help them identify their peak focus times.</li><li>Introduce active study techniques.</li><li>Discuss phone management honestly.</li><li>Connect the work to their goals.</li></ul><h2>What Destroys Focus — Stop Doing These</h2><ul><li>Hovering during study time</li><li>Marathon study sessions without breaks</li><li>Multitasking myths</li><li>Making study time a punishment</li></ul>`,
  sl_04: `<h1>Helping Kids Deal with Teasing</h1><p>Teasing exists on a spectrum. Light, mutual teasing between friends is a normal part of social bonding. Repeated, targeted teasing that makes a child feel humiliated is a form of bullying.</p><h2>Ages 6–9: Build the Toolkit</h2><ul><li><strong>The Shrug Response:</strong> 'So?' said with a shrug and walking away.</li><li><strong>The Agree and Deflect:</strong> Taking ownership removes its power as a weapon.</li><li><strong>The Humour Redirect:</strong> 'Good one!' and then changing the subject.</li><li><strong>The Boundary Statement:</strong> 'That's not funny to me. Stop.'</li></ul><h2>What Not to Do</h2><ul><li>'Just ignore it' without teaching them how</li><li>'Tease them back' — this escalates the situation</li><li>Over-protecting</li><li>Dismissing their pain: 'It's just teasing'</li></ul>`,
  sl_05: `<h1>Helping Kids Develop Reading Habits</h1><p>A child who reads regularly outperforms a child who does not in vocabulary, comprehension, empathy, critical thinking, and academic achievement across every subject.</p><h2>Ages 5–7: Make Reading a Warm Experience</h2><ul><li>Read aloud to them every day, even after they can read independently.</li><li>Let them choose any book.</li><li>Visit libraries and bookshops regularly.</li></ul><h2>Ages 8–10: Protect the Pleasure</h2><ul><li>Separate 'reading for school' from 'reading for fun.'</li><li>Let them abandon books they do not enjoy.</li><li>Introduce series.</li></ul><h2>Ages 11–13: Respect Their Autonomy</h2><ul><li>Never criticise their reading choices.</li><li>Connect reading to their interests.</li><li>Read alongside them.</li><li>Do not quiz them on what they read.</li></ul>`,
  sl_06: `<h1>Helping Kids Make Friends</h1><p>Friendship is a skill, not a gift. The parent's role is not to make friends for their child — it is to teach them the skills to make friends for themselves.</p><h2>Ages 3–5: Teach the Basics</h2><ul><li>Teach them to walk up, make eye contact, and say: 'Can I play with you?'</li><li>Arrange playdates with one child — not groups.</li><li>Teach sharing and turn-taking through games, not lectures.</li></ul><h2>Ages 6–9: Develop Friendship Skills</h2><ul><li>Help them find their people.</li><li>Teach conversation skills. Ask questions, listen, find common interests.</li><li>Coach them through conflict — teach them to repair rather than abandon friendships.</li></ul><h2>Ages 10–13: Navigate Social Complexity</h2><ul><li>Respect their social world.</li><li>Teach them that quality matters more than quantity.</li></ul><h2>What Undermines Friendship Skills — Stop Doing These</h2><ul><li>Arranging all their social life</li><li>Criticising their friends</li><li>Solving all their social problems instead of coaching</li></ul>`,
  sl_07: `<h1>Homework Struggles in Children</h1><p>Homework struggles are rarely about laziness. They are about the work being too hard, the child being too tired, the environment being wrong, or negative emotional associations.</p><h2>The Homework Environment Checklist</h2><ul><li>Quiet, consistent location</li><li>Good lighting and a comfortable chair</li><li>All supplies within reach</li><li>No screens within sight</li><li>Parent available nearby but not hovering</li></ul><h2>Ages 5–7: Keep It Light</h2><ul><li>Homework at this age should take 10–20 minutes maximum.</li><li>Make it part of the routine — same time, same place, every day.</li></ul><h2>Ages 8–10: Build Independence</h2><ul><li>Introduce a 'homework launch' routine: snack, then free time, then homework.</li><li>Help them plan the session.</li><li>Check the work after, not during.</li></ul><h2>Ages 11–13: Hand Over Responsibility</h2><ul><li>The homework is theirs, not yours.</li><li>Let the consequences happen if they do not do it.</li><li>Guide rather than give answers.</li></ul>`,
  sl_08: `<h1>Signs Your Child Is Being Bullied</h1><p>Most bullied children do not tell their parents. You need to be able to recognise the signs.</p><h2>Behavioural Signs</h2><ul><li>Avoidance of school — stomach aches on school mornings that disappear on weekends</li><li>Coming home hungry</li><li>Sleep disruption</li><li>Loss of interest in activities they previously enjoyed</li><li>Coming home with damaged or missing belongings</li></ul><h2>Emotional Signs</h2><ul><li>Increased irritability or emotional outbursts at home</li><li>Withdrawal from family and friends</li><li>Low self-esteem or self-critical language: 'Nobody likes me.'</li><li>Expressions of helplessness: 'There's no point.'</li></ul><h2>What to Do if You Recognise These Signs</h2><ul><li><strong>Step 1:</strong> Create a safe opening: 'I have noticed you seem a bit different lately.'</li><li><strong>Step 2:</strong> Observe more closely for a few weeks.</li><li><strong>Step 3:</strong> Talk to the school.</li><li><strong>Step 4:</strong> Strengthen their support network.</li></ul>`,
  sl_09: `<h1>Reducing School Stress</h1><p>Some school stress is normal and even healthy. But there is a point where it stops being productive and starts being harmful.</p><h2>Common Sources of School Stress by Age</h2><h3>Ages 5–7</h3><ul><li>Separation from parents</li><li>Learning to read and the pressure of keeping up with peers</li><li>Fear of getting things wrong</li></ul><h3>Ages 8–10</h3><ul><li>Increasing academic expectations</li><li>Standardised testing</li><li>Complex social dynamics</li></ul><h3>Ages 11–13</h3><ul><li>Academic pressure intensifying</li><li>Social media and peer comparison</li><li>Future anxiety</li></ul><h2>The Home as Stress Buffer</h2><p>Make home the antidote. Home should be where the child is valued for who they are, not what they produce.</p><h2>What Increases School Stress — Stop Doing These</h2><ul><li>Adding your own academic pressure</li><li>Comparing to others</li><li>Over-focusing on grades</li><li>Dismissing their stress</li><li>Over-scheduling</li></ul>`,
  sl_10: `<h1>School Anxiety in Children</h1><p>Some children wake up on school mornings with stomach aches that are real. They are not pretending — they are anxious.</p><h2>Common Causes</h2><ul><li><strong>Social anxiety:</strong> Fear of being judged, embarrassed, or rejected by peers.</li><li><strong>Academic anxiety:</strong> Fear of failing, not understanding, or being called on.</li><li><strong>Separation anxiety:</strong> Particularly in younger children.</li><li><strong>Bullying:</strong> A child who is being bullied may develop school anxiety even after the bullying has stopped.</li></ul><h2>How to Help</h2><ul><li><strong>Step 1 — Validate:</strong> 'I can see that going to school feels really scary for you right now. That feeling is real.'</li><li><strong>Step 2 — Identify the specific trigger.</strong></li><li><strong>Step 3 — Work with the school.</strong></li><li><strong>Step 4 — Gradual exposure, not avoidance.</strong></li><li><strong>Step 5 — Build coping strategies:</strong> Breathing exercises, a worry time, a calm morning routine.</li></ul><h2>When to Seek Professional Help</h2><p>School anxiety warrants professional support when the child is missing significant amounts of school, physical symptoms are persistent, the anxiety is not improving, or the child expresses hopelessness.</p>`,
  fr_01: `<h1>Age-Wise Behaviour Guide</h1><p>The number one question behind every parenting worry is: 'Is this normal?'</p><h2>Ages 3–4: The 'I Want It My Way' Stage</h2><ul><li>Tantrums (daily is normal)</li><li>Saying 'no' to everything</li><li>Difficulty sharing and taking turns</li><li>Imaginative fears</li><li>Physical aggression when frustrated</li></ul><h2>Ages 5–6: The 'Rules and Fairness' Stage</h2><ul><li>Tattling</li><li>Bossiness with peers</li><li>Sensitivity to criticism and a need for praise</li><li>Some separation anxiety around school transitions</li></ul><h2>Ages 7–9: The 'Social Awareness' Stage</h2><ul><li>Friendship drama</li><li>Comparing themselves to peers</li><li>Increased arguing and negotiating</li><li>White lies</li></ul><h2>Ages 10–11: The 'Pre-Teen Shift' Stage</h2><ul><li>Mood swings</li><li>Pulling away from parents while still wanting connection</li><li>Strong opinions and willingness to challenge authority</li><li>Increased interest in privacy</li></ul><h2>Ages 12–13: The 'Full Pre-Teen' Stage</h2><ul><li>Argumentative and increasingly skilled at it</li><li>Intense emotional reactions that seem disproportionate</li><li>Testing boundaries more deliberately than ever</li><li>Oscillating between wanting adult treatment and child-like needs</li></ul><h2>The Golden Rule</h2><p>If you are asking 'is this normal?' the answer is almost always yes. Any mention of self-harm or suicidal thoughts — take it seriously immediately.</p>`,
  fr_02: `<h1>Emotional Development Chart</h1><p>This chart maps what emotional skills and behaviours are typical at each age. Use this as a compass, not a ruler.</p><h2>Ages 3–4: What Is Developing</h2><ul><li>Basic emotional vocabulary (happy, sad, angry, scared)</li><li>Earliest impulse control (can wait briefly with support)</li><li>Understanding that other people have feelings</li><li>Ability to be soothed by a trusted adult</li></ul><h2>Ages 5–6: What Is Developing</h2><ul><li>Expanded emotional vocabulary (frustrated, embarrassed, proud, worried)</li><li>Early self-regulation — can calm down with strategies</li><li>Growing capacity for empathy and perspective-taking</li></ul><h2>Ages 7–9: What Is Developing</h2><ul><li>Self-regulation becoming more independent</li><li>Ability to see situations from another person's perspective</li><li>Understanding that people can feel two things at once</li><li>Growing capacity for delayed gratification</li></ul><h2>Ages 10–11: What Is Developing</h2><ul><li>Abstract emotional thinking</li><li>Ability to reflect on their own emotional patterns</li><li>Understanding of complex emotions (jealousy, guilt, loyalty)</li><li>Early identity formation</li></ul><h2>Ages 12–13: What Is Developing</h2><ul><li>Sophisticated emotional reasoning and self-awareness</li><li>Identity consolidation</li><li>Capacity for long-term goal-setting and self-motivation</li></ul><h2>When to Be Concerned</h2><p>Seek professional guidance if your child is significantly behind peers in multiple emotional areas, emotional development seems to be regressing, or challenges are significantly impacting daily functioning.</p>`,
  fr_03: `<h1>Habit Tracker for Kids</h1><p>Done well, a habit tracker transforms abstract goals into concrete, visible, daily actions that a child can own, measure, and feel proud of.</p><h2>Ages 3–5: The Visual Picture Tracker</h2><p>Format: A simple chart with pictures representing each habit. The child places a sticker when the habit is complete.</p><p>Good starter habits: brush teeth, put shoes by the door, put dirty clothes in the basket, help set the table.</p><h2>Ages 6–9: The Weekly Checklist Tracker</h2><p>Good habits to track: morning routine completed independently, reading for pleasure, homework started on time, room tidied before bed, one kind action.</p><h2>Ages 10–13: The Self-Directed Tracker</h2><p>Good habits to track: exercise, reading, homework session, screen-free time before bed, journaling, skill practice.</p><h2>How to Use Without Battles</h2><ul><li>Start with habits they are already close to doing.</li><li>Celebrate the process, not just the product.</li><li>Phase it out when the habit is automatic — typically after 6–12 weeks.</li><li>Never use the tracker as punishment.</li><li>Keep it simple.</li></ul>`,
  fr_04: `<h1>Parenting Checklist</h1><p>Use it as a quarterly check-in. Not a test. Not a judgment. Just a way to make sure the important things are getting attention.</p><h2>Ages 3–5</h2><ul><li>My child can name at least 5 emotions</li><li>I validate emotions before correcting behaviour</li><li>My child has a consistent bedtime routine</li><li>I read to my child daily</li><li>My child gets at least 60 minutes of physical activity daily</li><li>Bedtime is consistent and my child gets 10–13 hours of sleep</li><li>Screen time is limited (under 1 hour/day)</li></ul><h2>Ages 6–9</h2><ul><li>My child has at least one strategy for calming down when upset</li><li>I allow my child to experience frustration without immediately fixing it</li><li>I praise effort and persistence, not just outcomes</li><li>My child has age-appropriate responsibilities at home</li><li>My child can manage a morning routine with minimal reminders</li><li>Screen time is structured and balanced with other activities</li></ul><h2>Ages 10–13</h2><ul><li>I listen more than I advise</li><li>My child has healthy coping strategies for stress</li><li>My child knows I love them unconditionally</li><li>My child manages their own homework with minimal parental oversight</li><li>My child has interests and activities that are theirs, not mine</li><li>My child has unstructured free time — not every hour is scheduled</li></ul>`,
  fr_05: `<h1>Parenting Tools for Modern Parents</h1><p>The problem is not lack of resources — it is knowing which ones actually help.</p><h2>The Essential Toolkit</h2><h3>1. A Daily Routine System</h3><p>A visual schedule chart for ages 3–7, a family calendar, a consistent morning and evening routine checklist.</p><h3>2. A Habit Tracking System</h3><p>A paper-based habit tracker for younger children, a bullet journal or printed monthly grid for pre-teens.</p><h3>3. An Emotional Development Resource</h3><p>An emotional development chart, feelings cards or emotions posters for younger children, books about emotions.</p><h3>4. A Communication Framework</h3><p>'I feel _____ because _____' sentence structure, the 'validate, then redirect' approach, daily check-in questions.</p><h3>5. A Screen Time Management System</h3><p>A family media agreement, a device charging station outside bedrooms, a daily routine where screens have a defined place.</p><h2>How to Choose Tools That Actually Help</h2><ul><li>Does it fit into your existing life?</li><li>Is it evidence-based?</li><li>Does it empower the child, not just the parent?</li><li>Is it sustainable?</li><li>Does it reduce your stress, not add to it?</li></ul>`,
  fr_06: `<h1>School Readiness Guide</h1><p>The children who do best in their first year of school are not necessarily the ones who can read earliest. They are the ones who can sit in a group, follow a simple instruction, manage their emotions when frustrated, share materials, and ask for help.</p><h2>The Four Domains of School Readiness</h2><h3>1. Emotional Readiness</h3><ul><li>Can separate from you without prolonged distress</li><li>Can cope with minor frustrations without a complete meltdown</li><li>Can express basic needs verbally</li><li>Can manage transitions</li></ul><h3>2. Social Readiness</h3><ul><li>Can play cooperatively with other children</li><li>Can share and take turns (with support)</li><li>Can follow simple group instructions</li><li>Can communicate needs to an adult who is not their parent</li></ul><h3>3. Academic Readiness</h3><ul><li>Recognises their own name in print</li><li>Can hold a pencil or crayon</li><li>Can count objects to at least 10</li><li>Shows curiosity and asks questions</li></ul><h3>4. Physical Readiness and Self-Care</h3><ul><li>Can use the toilet independently</li><li>Can dress themselves</li><li>Can open their lunch box and water bottle</li><li>Can sit for 10–15 minutes</li></ul><h2>How to Prepare Your Child</h2><ul><li>Talk positively about school — but honestly.</li><li>Visit the school if possible — familiarity reduces anxiety.</li><li>Practise the morning routine.</li><li>Build independence in self-care tasks.</li></ul>`,
};
...
function ArticleView({ view, onNavigate, onHome }: { view: ViewState; onNavigate: (v: ViewState) => void; onHome: () => void }) {
  if (view.type === "landing") {
    return (
      <div className="text-center py-20 px-6 relative">
        ...
        <button
          onClick={onHome}
          className="absolute top-20 left-20 inline-flex items-center gap-2 text-[#f97316] transition-colors duration-200"
        >
  ...
  return (
    <div className="max-w-[860px] mx-auto px-6 py-10">
      {/* breadcrumb */}
      <div className="flex items-center gap-2 text-[0.8rem] text-gray-400 mb-8 flex-wrap">
        <button onClick={onHome} className="text-[#f97316] font-medium hover:underline">
          Home
        </button>
        <span>›</span>
    ...
    <>
      ...
      <div className="min-h-screen relative z-[1]" style={{ background: "radial-gradient(ellipse 60% 80% at 50% 50%, rgba(249,115,22,0.07) 0%, transparent 70%)" }}>
        <motion.div
          ...
          transition={{ duration: 0.35 }}
        >
          <ArticleView view={view} onNavigate={navigate} onHome={goHome} />
        </motion.div>
      </div>
    </>
  );
