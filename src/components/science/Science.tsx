...
/**
 * Science — "Built on science, not opinion"
 *
 * SERVER COMPONENT. No "use client" needed:
 *   - no state, no hooks, no event handlers, no interactivity
 *   - purely presentational, so it ships as static HTML (zero client JS)
 *
 * Tailwind-first — no <style> block needed at all here; everything the design
 * calls for maps cleanly onto utility classes with arbitrary values, so no
 * tailwind.config changes are required.
 *
 * Image: swap the placeholder path under /images/science/.
...
export default function Science() {
  return (
    <section className="relative w-full bg-[#050507] px-5 sm:px-7 lg:px-8 py-[clamp(56px,7vw,110px)] font-['Poppins',sans-serif] text-[#c3c2ce] antialiased">
      <div className="mx-auto max-w-[950px]">
        ...
        {/* Infographic */}
        <figure className="relative mx-auto max-w-full overflow-hidden rounded-[34px] shadow-[0_40px_100px_rgba(0,0,0,0.5)] max-[560px]:rounded-[22px]">
          <img
            src={`${IMG_BASE}/science.webp`}
            alt="Brain regions and synaptic density curve across ages, highlighting the 10-year window"
